...
for($count=0;$count<=$total;$count++){
	...
	else if(strcmp($guild[$count]["class"],"Hero")==0) {
...
<p>\n";
$plus50=Classlevel_Table(49,51,"members at level 50");
$plus40=Classlevel_Table(39,50,"Members at level 40-49");     
$plus30=Classlevel_Table(29,40,"Members at level 30-39");     
$plus20=Classlevel_Table(19,30,"Members at level 20-29");     

print "Members at level 1-20 (" .$temp=$guildtemp-($plus20+$plus30+$plus40+plus50) .")\n
<p>\n";
