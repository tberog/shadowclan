...
while($element = each($classarray)) {
	print "<TR><TD><a href=\"sc2.php?page=ClassRank&ClassR=" .$element["key"] ."&Tribe=$Rank\">" .$element["key"] ."</a></td>";
...
if ($Class){
	switch($Rank) {
	case "9": $text="Pomdung " .$Class;break;
	case "8": $text="Grundurz " .$Class;break;
	case "7": $text="Trokakh " .$Class;break;
	case "6": $text="Kraksha " .$Class;break;
	default: $text="";
	}
sscanf($Rank,"%d",$Rank);
...
print <<<EOD
<body text="#CCCCCC" bgcolor="#000000" link="#FF4400" vlink="#FF4400" alink="#FF4400" background="marble4.jpg">
...
<tr><td>\n
<a href=\"sc2.php?page=\"><b>$guildname Tribes</b></a><td> \n ";
...
else if(strcmp($page,"Pomdung")==0) {
        Rank_Table(9,"Pomdung Tribe",""); }
else if(strcmp($page,"Grundurz")==0) {
        Rank_Table(8, "Grundurz Tribe","") ;}
else if(strcmp($page,"Trokakh")==0) {
        Rank_Table(7, "Trokakh Tribe","") ;}
else if(strcmp($page,"Kraksha")==0) {
        Rank_Table(6, "Kraksha Tribe","") ;}
else{
print "<TABLE BORDER=1 WIDTH=100% cellpadding=0 cellspacing=0>\n<TR><td valign=top width=50%>\n";

print "<TABLE BORDER=1 WIDTH=100%>\n<TR>\n";
print "<td width=30%><center><a href=\"sc2.php?page=Pomdung\"><font size=+1>Pomdung Tribe</font></a>";
print "</TABLE>\n";
...
print "<td valign=top>";
print "<TABLE BORDER=1 WIDTH=100%>\n<TR>\n";
print "<td width=30%><center><a href=\"sc2.php?page=Grundurz\"><font size=+1>Grundurz Tribe</font></a>";
print "</TABLE>\n";
print"<p align=center>";
Rank_Table(3,"Nobs","") ;  
print "<BR>\n";  
...
print "<TABLE BORDER=1 WIDTH=100%>\n<TR>\n";
print "<td width=30%><center><a href=\"sc2.php?page=Trokakh\"><font size=+1>Trokakh Tribe</font></a>";
print "</TABLE>\n";
print"<p align=center>";
Rank_Table(2,"Nobs","") ;    
print "<BR>\n";
...
print "<td valign=top>";
print "<TABLE BORDER=1 WIDTH=100%>\n<TR>\n";
print "<td width=30%><center><a href=\"sc2.php?page=Kraksha\"><font size=+1>Kraksha Tribe</font></a>";
print "</TABLE>\n";
print"<p align=center>";
Rank_Table(1,"Nobs","") ;    
print "<BR>\n";
